...
public class BackgroundRenderer {
     ...
     * and {@link com.google.ar.core.Camera#getProjectionMatrix(float[], int, float, float)}
     * will accurately follow static physical objects.
     * This must be called <b>before</b> drawing virtual content.
     *
     * @param frame The last {@code Frame} returned by {@link com.google.ar.core.Session#update()}.
     */
