...
class LocationController (
    ...
    var lastUpdateChangedMapPos = true
    ...
    private fun createLocationCallback() {
        ...
        locationCallback = object : LocationCallback() {
            override fun onLocationResult(locationResult: LocationResult?) {
                ...
                currentLocation?.let { cur -> locationResult!!.lastLocation.let {
                    lastUpdateChangedMapPos =
                            (cur.latitude != it.latitude || cur.longitude != it.longitude)
                }}
