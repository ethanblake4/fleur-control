...
import org.flyline.math.Quaternion;
 ...
 *
 */public class SensorFusionProvider extends OrientationProvider {
     ...
     */
    public SensorFusionProvider(SensorManager sensorManager) {
        super(sensorManager);
